...
// Configure prepares a HashiCups API client for data soruces and resources
...
Either target apply the source of the value first, set the value statically in the configuration, or use the HASHICUPS_HOST environment variable.`,
	...
	tflog.Debug(ctx, "Createing HashiCups API Client")

	// Create a new HashiCups API client using the configuration values
...
// Resources defines the resoruces implemented in the provider
